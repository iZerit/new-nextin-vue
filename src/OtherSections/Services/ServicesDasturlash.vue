        ...
        <div class="service-card">
          ...
          <div class="card-content">
            ...
            <div class="card-image">
              <img class="img-fluid" src="/src/assets/services/webprogramm/1.png" alt="Markup Languages">
            </div>
            <h3 class="card-title">{{ $t('markup_title') }}</h3>
            <p class="card-text">{{ $t('markup_intro') }}</p>
            <div class="card-features">
              <span class="feature-tag">HTML5</span>
              <span class="feature-tag">CSS3</span>
              <span class="feature-tag">Semantic</span>
            </div>
          </div>
        </div>

        <!-- Script Languages Card -->
        <div class="service-card">
          <div class="card-glow"></div>
          <div class="card-content">
            <div class="card-icon">
...
<style scoped>
/* Enhanced Programming Section Styles */
.web_programming {
  position: relative;
  color: white;
  padding: 2rem 0;
